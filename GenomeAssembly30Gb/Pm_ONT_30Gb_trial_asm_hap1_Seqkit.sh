...
INPUT="Pm_ONT_30Gb_trial.asm.hic.hap1.p_ctg.gfa"

# Convert GFA to FASTA
awk '/^S/{print ">"$2"\n"$3}' ${INPUT} > Pm_ONT_30Gb_trial.hap1.asm.fa

# Get stats
seqkit stats -a -j 24 Pm_ONT_30Gb_trial.hap1.asm.fa > Pm_ONT_30Gb_trial.hap1.asm.stats.txt
