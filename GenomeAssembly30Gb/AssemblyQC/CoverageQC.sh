################## Before I did this step I combined both haplotypes into one file #########################
...
cd /scratch/xf3/ls9057/Pmelanocephala/638001_LibID640766_PP_BRF_PBI90827_ONTPromethION_fastq_pass/Pm_asm

# combine both haplotype assemblies into one file
cat Pm_ONT_30Gb_trial.hap1.asm.fa Pm_ONT_30Gb_trial.hap2.asm.fa > Pm_ONT_30Gb_trial.hap12.asm.fa

################################# Then, I did the coverage QC ############################################
