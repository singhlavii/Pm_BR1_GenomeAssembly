...
INPUT="Pm_ONT_30Gb_trial.asm.hic.hap2.p_ctg.gfa"

# Convert GFA to FASTA
awk '/^S/{print ">"$2"\n"$3}' ${INPUT} > Pm_ONT_30Gb_trial.hap2.asm.fa

# Get stats
seqkit stats -a -j 24 Pm_ONT_30Gb_trial.hap2.asm.fa > Pm_ONT_30Gb_trial.hap2.asm.stats.txt
